...
namespace amst\Custom;

use amst\Api\Settings;
use amst\Api\Callbacks\SettingsCallback;
...
class Admin
{
	...
	private function enqueue()
	{
		...
		$pages = array( 'toplevel_page_amst' );
	...
	private function enqueue_faq( Settings $settings )
	{
		...
		// Pages array to where enqueue scripts
		$pages = array( 'amst_page_amst_faq' );
	...
	private function settings()
	{
		...
		$args = array(
			array(
				'option_group' => 'amst_options_group',
				'option_name' => 'first_name',
				'callback' => array( $this->callback, 'amst_options_group' )
			),
			array(
				'option_group' => 'amst_options_group',
				'option_name' => 'amst_test2'
			)
		);
	...
	private function sections()
	{
		...
		$args = array(
			array(
				'id' => 'amst_admin_index',
				'title' => 'Settings',
				'callback' => array( $this->callback, 'amst_admin_index' ),
				'page' => 'amst'
			)
		);
