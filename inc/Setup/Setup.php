...
class Setup
{
    ...
    public function setup()
    {
         ...
         */
        // load_theme_textdomain( 'amst', get_template_directory() . '/languages' );
        ...
        // add_theme_support( 'custom-background', apply_filters( 'amst_custom_background_args', array(
