...
use amst\Api\Customizer\Sidebar;
use amst\Api\Customizer\Header;
use amst\Api\Customizer\Footer;
...
class Customizer 
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'amst_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'amst_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'amst_header_background_color' );
			echo self::css( '.site-header', 'color', 'amst_header_text_color' );
			echo self::css( '.site-header a', 'color', 'amst_header_link_color' );
